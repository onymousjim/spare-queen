...
(async () => {
  ...
  await page.screenshot({ path: 'frontend/src/tests/screenshots/image-upload.png' });
  ...
  await page.screenshot({ path: 'frontend/src/tests/screenshots/manual-entry.png' });
  ...
  await page.screenshot({ path: 'frontend/src/tests/screenshots/edit-scores.png' });
  ...
  await page.screenshot({ path: 'frontend/src/tests/screenshots/metrics.png' });
